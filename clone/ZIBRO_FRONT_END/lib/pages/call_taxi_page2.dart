...
import 'package:texi_application/pages/taxi_ride.dart';
...
class CallTaxiPage2 extends StatefulWidget {
  const CallTaxiPage2({super.key});

  @override
  State<CallTaxiPage2> createState() => _CallTaxiPage2();
}
...
//메인 빌드 클래스
class _CallTaxiPage2 extends State<CallTaxiPage2> {
  ...
  void _startRouteAnimation() {
    _timer = Timer.periodic(const Duration(seconds: 3), (timer) async {
      ...
      try {
        _updateRoute(routes[_currentStep].lat, routes[_currentStep].lng,
  ...
  void _updateRoute(
    ...
    await _fetchRoute(startLat, startLng, endLat, endLng);
                      ...
                      GestureDetector(
                        onTap: () {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const TaxiRidePage()),
                          );
                        },
